...
const int Bone::GetPositionIndex(float animationTime)
{
...
const int Bone::GetRotationIndex(float animationTime)
{
...
const int Bone::GetScaleIndex(float animationTime)
{
