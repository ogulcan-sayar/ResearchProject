...
namespace Dalak.Ecs
{
    ...
    /// https://gamedev.stackexchange.com/questions/71767/how-can-i-efficiently-implement-a-bitmask-larger-than-64-bits-for-component-exis
    /// </summary>
    public class BitSet 
    {
        ...
        /// </summary>
        /// <param name="other">The bitset to check.</param>
        public bool AnyMatchingBits(BitSet other)
        {
            if (other == null)
            {
                throw new ArgumentNullException("other");
